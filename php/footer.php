<footer class="bg-dark text-white text-center py-3 mt-auto">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="https://41183897.servicio-online.net/assets/logo-white.png" alt="PixFly" style="height: 40px; margin-bottom: 15px;">
            ...
            <div class="col-md-4">
                ...
                <a href="https://www.facebook.com/?locale=es_ES" class="text-white me-2"><i class="bi bi-facebook"></i></a>
                <a href="https://x.com/" class="text-white me-2"><i class="bi bi-twitter-x"></i></a>
            </div>
        </div>
        <hr>
        <div class="text-center">
            <p class="mb-0">&copy; <?php echo date("Y"); ?> PixFly. Todos los derechos reservados.</p>
        </div>
    </div>
</footer>